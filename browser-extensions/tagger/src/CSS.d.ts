...
declare class Highlight {
  ...
  * 
   ...
   * @returns Iterable<[Range, Range]> - A new iterator object that contains an array of [range, range] for each Range object in the given Highlight, in insertion order.
   */
  entries(): Iterable<[Range, Range]>;
...
declare namespace CSS {
   ...
   */
  let highlights: HighlightRegistry;
}
